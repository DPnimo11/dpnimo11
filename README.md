...
- [LeetLoop](https://github.com/DPnimo11/leetloop): local-first Next.js tracker for coding interview prep with spaced repetition scheduling, attempt logging, templates, and JSON backups.
